...
namespace Secure_Backup_System
{
	public partial class AdminLogin : Form
	{
		...
		private void btn_login_Click(object sender, EventArgs e)
		{
			...
			string sql = "SELECT Salt, Password FROM Admin WHERE Username = @Username";
			byte[] salt = null;
			...
			{
				con.Open();
				SqlCommand command = new SqlCommand("select email from Admin where Username='" + (usernameTextBox.Text) + "'", con);
